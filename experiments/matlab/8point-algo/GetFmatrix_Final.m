...
% question: it seems like you're adjusting 

%           for the size of the image, 
%           so the center is where it is suppose to be
N=[ 2/Width 0        -1;
    0       2/Height -1;
    0       0         1];
...
% Xiao: It seems like A is formed manually, and then SVD gives you V, 
%       which reshaped to get you F
% 
...
% make rank 2 sinc we have u' F u = 0
[U D V] = svd(F);
